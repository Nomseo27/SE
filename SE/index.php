...
<<<<<<< HEAD
          ...
          <div class="icon-block">
            ...
            <h2 class="center white-text"><i class="material-icons large">shopping-cart</i></h2>
            <h5 class="center">NFCtel Promos </h5>
...
<<<<<<< HEAD
         <div class="card-panel teal hoverable">
             <a class = "white-text" href="#">
          <div class="icon-block">
            <h2 class="center white-text"><i class="material-icons large">hotel</i></h2>
            <h5 class="center">Reserve A Room</h5>
...
<<<<<<< HEAD
         <div class="card-panel teal hoverable">
             <a class = "white-text" href="#">
          <div class="icon-block">
            <h2 class="center white-text"><i class="material-icons large">event</i></h2>
            <h5 class="center">Book A Event</h5>
...
<<<<<<< HEAD
      ...
      <div class="col s12 m4 l11 hoverable">
            <div class="card-action">
                <p><a style = "font-size:20px;" href="#">See All Events &#x27b2;</a></p>
            </div>
      </div>
      </div><!--row ends here-->
...
<<<<<<< HEAD
      <div class="col s12 m4 l12 hoverable">
            <div class="card-action">
                <p><a style = "font-size:20px;" href="#">See All Hotels &#x27b2;</a></p>
            </div>
      </div>
=======
