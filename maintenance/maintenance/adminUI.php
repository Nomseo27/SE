            ...
            <nav class="grey darken-4">
                <div class="nav-wrapper">                    
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="events.php" class="waves-effect waves-block waves-light toggle-fullscreen pink-text"><i class="mdi-social-cake"></i></a>
                        </li>
                        <li><a href="membersmainte.php" class="waves-effect waves-block waves-light"><i class="mdi-social-person-add pink-text"></i></a>
                        </li>                        
                        <li><a href="amenities.php" class="waves-effect waves-block waves-light"><i class="mdi-social-location-city pink-text"></i></a>
                        </li>                        
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation grey darken-4">
            ...
            <li class="bold"><a href="index-2.html" class="waves-effect waves-pink pink-text"><i class="mdi-action-dashboard"></i> Dashboard</a>
            </li>
                ...
                <ul class="collapsible collapsible-accordion grey darken-4">
                    <li class="bold"><a class="collapsible-header waves-effect waves-pink pink-text"><i class="mdi-social-location-city"></i> Rooms</a>
                        <div class="collapsible-body grey darken-3">
                            <ul>
                                <li><a href="css-typography.html" class="pink-text text-lighten-4">Bed Rooms</a>
                                </li>                                        
