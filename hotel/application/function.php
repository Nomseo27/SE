            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Function Rooms</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="row-grouping" class="section">
              <h4 class="header">Function Room</h4>
                  ...
                  <table id="data-table-simple" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $stmt = sqlsrv_query($conn,'{CALL SP_DISPLAYFUNC}');
                  ...
                  <div class="nav-wrapper">
                    <div class="left col s12 m5 l5">
                      <ul>
                        ...
                        <li><a href="#!" class="email-type">ADD Function Room</a>
                        </li>
                      </ul>
                    </div>
