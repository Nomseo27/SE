          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumb">
                    <li><a href="index-2.html" class="pink-text">Events</a></li>
                </ol>
              </div>
            </div>
          </div>
			...
			<div class="modal-content">
				...
				<div class="row">         
					<div class="col s12">
						...
						<div class="input-field col s6">
							<i class="mdi-action-payment prefix"></i><br /><br />
							<input id="room_number" type="text" class="validate">
				...
				<div class="row">         
					<div class="col s12">
						<div class="input-field col s4">
							<i class="mdi-av-timer prefix"></i><br /><br />
						...
						<div class="input-field col s4">
							<i class="mdi-social-domain prefix"></i><br /><br />
