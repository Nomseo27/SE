                  ...
                  <table id="data-table-simple" class="display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            $stmt = sqlsrv_query($conn,'{CALL SP_DISPLAYAMEN}');
                  ...
                  <div class="nav-wrapper">
                    <div class="left col s12 m5 l5">
                      <ul>
                        ...
                        <li><a href="#!" class="email-type">ADD Amenities</a>
                        </li>
                      </ul>
                    </div>
                   ...
                   <form class="col s12 center" method="post" action="amenAdd.php">
                    ...
                    <div class="row" id="function">
                        <div class="input-field col s12">
                            ...
                            <label for="amenities" class="">Service Descriptions</label>
                        </div>
                    </div>
                       <ul class="right">
