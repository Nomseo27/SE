      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
              ...
              <?php 
            echo "  <h5>".$rid."</h5>
            <form class='col s12 center' name='modaled' method='post' action='bedrEdit.php'> 
                <div class='row'>
                <div class='input-field col s6'>
                    <input name='roomno' type='text' class='validate' value='".$rno."'>
                    <label for=first_name'>Room Number</label>
                </div>
            </div>
            <div class='row'>
                <div class='input-field col s6'>
                    <input placeholder='Php' name='Price' type='text' class='validate' value='".$rprice."'>
                    <label for='price'>Price</label>
                </div>
                <div class='input-field col s6'>
                    <select name='rate' value='".$rrate."'>
            ...
            <div class='row' id='room'>
                <div class='input-field col s12'>
                      ...
                      <textarea name='roomdes' class='materialize-textarea' value=".$rdes."></textarea>
                      <label for='roomdes' class=''>Message</label>
                    </div>
            </div>
            <ul class='right'>
                         
                        <li><input class='input-field btn center grey darken-4 pink-text' type='submit' name='submit' value='SAVE'>
                        </li>
                      </ul>
            <ul class='right'>
                         
                        <li><input class='input-field btn center grey darken-4 pink-text' type='submit' name='submit' value='DELETE'>
                        </li>
                      </ul>           
